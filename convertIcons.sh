...
do
	...
	PNG_BW=`echo ${SVG} | sed -e "s/\.svg/-bw\.png/g"`
	#convert ${SVG} -density 1200 -resize 200x200 -crop 120x120+40+40 -fuzz 40% -transparent "white" ${PNG}
	convert ${SVG} -density 1200 -resize 200x200 -crop 120x120+40+40 -fuzz 40% -transparent "white" -type Grayscale -fill white -colorize 90% ${PNG_BW}
